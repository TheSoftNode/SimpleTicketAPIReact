...
const TicketsIndexPage = lazy(
  () => import("../pages/tickets/TicketsIndexPage")
);
const TicketsCreatePage = lazy(
  () => import("../pages/tickets/TicketsCreatePage")
);
const TicketsDetailsPage = lazy(
  () => import("../pages/tickets/TicketsDetailsPage")
);
const TicketsEditPage = lazy(() => import("../pages/tickets/TicketsEditPage"));
const TicketsDeletePage = lazy(
  () => import("../pages/tickets/TicketsDeletePage")
);
